...
// 내비 메뉴 클릭 시 해당 박스로 부드럽게 이동
$('.side-menu li').on('click', (e) => {
  const idx = $(e.currentTarget).index();
  // const currentBox = 100 * idx; scrollTop, scrollTo 는 px로 반환 받음
  ...
  $('html, body').stop().animate({ scrollTop: currentBox} , 800, 'easeOutCirc');
});
